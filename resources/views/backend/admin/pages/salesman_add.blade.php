    ...
    <div class="page-content">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class=" text-center mb-2">Salesman Add</h3>
                        @if (session('success'))
                        ...
                        @endif
                        <form action="{{route('admin.salesman.add')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select js-example-basic-single" name="user_type" id="" >
                                        ...
                                        <option value="salesman">Admin</option>
                                    </select>
                                </div>
